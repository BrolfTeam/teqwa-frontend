...
const DonationProgressWidget = memo(({ className = '' }) => {
  ...
  useEffect(() => {
    const fetchDonationData = async () => {
      try {
        ...
        try {
          ...
          // Stats endpoint may require auth, try public donation list
          try {
    ...
    const interval = setInterval(fetchDonationData, 5 * 60 * 1000);
          ...
          {activeCause && (
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-xs text-muted-foreground">
                ...
                <span>Goal: {(activeCause.target_amount || 0).toLocaleString()} ETB</span>
              </div>
            </div>
          )}
        </div>
...
const Home = memo(() => {
  ...
  const heroSlides = useMemo(() => {
    ...
    return getHeroSlides(featuredEvents, activeCampaigns);
  }, [upcomingEvents, donationCauses]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background font-sans selection:bg-primary/20 w-full overflow-x-hidden">
      ...
      >
            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              {currentSlideData?.khatib && currentSlideData.khatib.name && (
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-white/80 mb-1">Today's Khutbah by</p>
              ...
              {currentSlideData?.type === 'campaign' && currentSlideData.raised !== undefined && (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-2 text-xs text-white/80">
                    <span>{(currentSlideData.raised || 0).toLocaleString()} ETB raised</span>
                    <span>Goal: {(currentSlideData.target || 0).toLocaleString()} ETB</span>
                  </div>
                </motion.div>
              )}
        ...
        {heroSlides.length > 1 && (
          <>
            {/* Previous/Next Buttons - Modern Design */}
            <motion.button
              onClick={prevSlide}
              className="absolute left-4 md:left-6 top-1/2 -translate-y-1/2 z-30 p-3 md:p-4 rounded-full bg-white/10 backdrop-blur-lg border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300 text-white shadow-lg hover:shadow-xl group"
            ...
            <motion.button
              onClick={nextSlide}
              className="absolute right-4 md:right-6 top-1/2 -translate-y-1/2 z-30 p-3 md:p-4 rounded-full bg-white/10 backdrop-blur-lg border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300 text-white shadow-lg hover:shadow-xl group"
            ...
            >
              ...
              <div className="flex items-center justify-center mb-10 sm:hidden">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground text-lg">Access our services and resources</p>
                </div>
              </div>
              ...
              {[
                { title: 'News', icon: FiBookOpen, to: '/news', color: 'text-blue-500', bg: 'bg-blue-500/10', hoverBg: 'hover:bg-blue-500/20' },
                { title: 'Education', icon: FiBookOpen, to: '/education', color: 'text-green-500', bg: 'bg-green-500/10', hoverBg: 'hover:bg-green-500/20' },
                { title: 'Events', icon: FiCalendar, to: '/events', color: 'text-purple-500', bg: 'bg-purple-500/10', hoverBg: 'hover:bg-purple-500/20' },
                { title: 'Donate', icon: FiHeart, to: '/donations', color: 'text-red-500', bg: 'bg-red-500/10', hoverBg: 'hover:bg-red-500/20' },
                { title: 'Services', icon: FiUsers, to: '/services', color: 'text-orange-500', bg: 'bg-orange-500/10', hoverBg: 'hover:bg-orange-500/20' },
                { title: 'Contact', icon: FiMapPin, to: '/contact', color: 'text-teal-500', bg: 'bg-teal-500/10', hoverBg: 'hover:bg-teal-500/20' },
              ].map((item, index) => (
                <motion.div
                  key={item.title}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container container-padding relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <span className="inline-block px-4 py-2 bg-white/20 backdrop-blur-md rounded-full text-sm font-semibold mb-6 border border-white/30 text-white">Ramadan Special</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight text-white">
                Mu'a Teqif: <span className="text-accent-300">Spiritual Retreat</span>
              </h2>
              <p className="text-lg md:text-xl text-white/95 max-w-3xl mx-auto leading-relaxed">
                Experience profound tranquility and spiritual renewal in the House of Allah
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {[
                {
                  image: itikafImage,
                  title: "24-Hour Retreat",
                  description: "Stay in the masjid for a full day of worship, reflection, and peace. Open year-round for all worshippers.",
                  color: "text-orange-500"
                },
                {
                  image: itikafImage2,
                  title: "10 Days in Ramadan",
                  description: "Experience the last 10 days of Ramadan in spiritual seclusion, nightly prayers, and community.",
                  color: "text-orange-500"
                },
                {
                  image: mesjidBg,
                  title: "Spiritual Atmosphere",
                  description: "Connect with Allah, join group prayers, and find tranquility in the masjid environment.",
                  color: "text-orange-500"
                }
              ].map((card, index) => (
                <motion.div
        ...
        <div className="container container-padding relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <span className="inline-block px-4 py-2 bg-white/20 backdrop-blur-md rounded-full text-sm font-semibold mb-6 border border-white/30 text-white">Sports & Recreation</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight text-white">
                Why Play <span className="text-accent-300">Here?</span>
              </h2>
              <p className="text-lg md:text-xl text-white/95 max-w-3xl mx-auto leading-relaxed">
                Enjoy premium facilities and build community bonds through sports
              </p>
            </motion.div>
              ...
              {[
                {
                  image: futsalImage1,
                  title: "Premium Turf",
                  description: "Enjoy a high-quality playing surface for a smooth and safe game.",
                  color: "text-green-600"
                },
                {
                  image: futsalImage2,
                  title: "Friendly Matches",
                  description: "Play with friends or join other players for competitive fun.",
                  color: "text-green-600"
                },
                {
                  image: futsalImage3,
                  title: "Flexible Timings",
                  description: "Book slots anytime with easy online booking options.",
                  color: "text-green-600"
                }
              ].map((card, index) => (
                <motion.div
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Join us for meaningful gatherings that strengthen our community bonds and deepen our faith
              </p>
            </motion.div>
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                >
                  ...
                  <p className="text-muted-foreground text-lg">No upcoming events at this time. Check back soon!</p>
                </motion.div>
              </div>
            )}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-white">
                Join Our <span className="text-accent-300">Community</span>
              </h2>
              <p className="text-lg md:text-xl text-white/95 max-w-3xl mx-auto leading-relaxed">
                Become a part of our family — volunteer, learn, and support the mosque's mission to serve everyone with compassion and dedication.
              </p>
            </motion.div>
            ...
            {announcements.length > 0 && (
              ...
              >
                <div className="text-center mb-12">
                  <h3 className="text-2xl md:text-3xl font-bold mb-3 text-white">Latest Announcements</h3>
                  <p className="text-white/90 text-lg">Stay updated with our community news</p>
                </div>
