  ...
  useEffect(() => {
    const fetchMedia = async () => {
      try {
        ...
        setError(t('gallery.unableToLoadGallery'));
        setMediaItems([]);
      } finally {
        setIsLoading(false);
      }
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="bg-gradient-to-r from-brand-deep to-brand-green text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">{t('gallery.mediaGallery')}</h1>
          <p className="text-xl max-w-2xl mx-auto">{t('gallery.exploreDescription')}</p>
          ...
          <div className="max-w-2xl mx-auto mt-8 relative">
            <div className="relative">
              <input
                type="text"
                placeholder={t('gallery.searchGallery')}
              ...
              {filteredMedia.map((media) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-4">
                    <h3 className="text-white font-medium text-lg">{media.title || t('gallery.untitled')}</h3>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground mb-6">
                {searchTerm || selectedCategory !== 'all'
                  ? t('gallery.tryAdjustingSearch')
                  : t('gallery.eventImagesWillAppear')}
              </p>
              {(searchTerm || selectedCategory !== 'all') && (
                <button
                  onClick={() => {
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-semibold">{t('gallery.mosqueCollegePhotos')}</h2>
            <p className="text-sm text-muted-foreground">{t('gallery.curatedCollection')}</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              { id: 'asset-1', url: mosque1, title: t('gallery.mainHall') },
              { id: 'asset-2', url: mosque2, title: t('gallery.communityLogo') },
            ].map(img => (
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-foreground mb-2">{selectedMedia.title || t('gallery.untitled')}</h3>
      ...
      <section className="bg-brand-deep text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">{t('gallery.shareYourMoments')}</h2>
